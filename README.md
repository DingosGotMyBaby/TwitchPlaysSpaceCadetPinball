# TwitchPlaysSpaceCadetPinball

Forked from https://github.com/alula/SpaceCadetPinball  
So the readme below is from that.  
Valid commands are:  
| Command | Mods/VIPs Only |
| :---------------- | :------: |  
| !left |   []   |  
| !right |   []   |  
| !launch |  [x]   |  
...
* All subs were decompiled, C pseudo code was converted to compilable C++. Loose (namespace?) subs were assigned to
  classes.
